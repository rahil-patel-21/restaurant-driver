  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: _con.order == null
          ...
          : Container(
              height: _con.order.orderStatus.id == '5' ? 190 : 300,
              padding: EdgeInsets.symmetric(horizontal: 20, vertical: 15),
              decoration: BoxDecoration(
                  color: Theme.of(context).primaryColor,
                  borderRadius: BorderRadius.only(topRight: Radius.circular(20), topLeft: Radius.circular(20)),
                      ...
                      children: [
                        Row (children: [
                          Expanded(child:
                            FlatButton(
                              onPressed: () async {
                                var url = 'https://www.google.com/maps/search/?api=1&query=${position.latitude},${position.longitude}';
                              ...
                              color: Theme.of(context).primaryColor,
                              shape: StadiumBorder(side: BorderSide( color: Theme.of(context).accentColor, width: 2.0, )),
                              child: Text(
                                "Get Direction",
          ...
          : CustomScrollView(slivers: <Widget>[
              SliverAppBar(
                ...
                leading: new IconButton(
                  ...
                  onPressed: () => /*_con.scaffoldKey?.currentState?.openDrawer()*/Navigator.of(context).pushReplacementNamed('/Pages', arguments: 2),
